...
_CLOUD_DEFAULTS: dict = {
    ...
    "crawler": {
        ...
        "priority_keywords": [
            ...
            "minister", "committee", "administration", "team", "telephone",
            "tele-directory", "phone-directory", "email",
        ],
        "skip_extensions": [
    ...
    "extraction": {
        ...
        "role_local_parts": [
            "webmaster", "info", "admin", "contact",
            "support", "helpdesk", "grievance",
        ],
        "confidence": {
        ...
        "person": {
            ...
            "designation_keywords": [
                "Secretary", "Director", "Commissioner", "Collector",
                "Superintendent", "Inspector", "Officer", "Manager",
                "Chairman", "President", "Minister", "Deputy", "Additional",
                "Principal", "Chief", "Joint", "Under Secretary",
                "IAS", "IPS", "IFS", "IRS", "Jt", "Jr", "Junior",
            ],
            "proximity_chars": 300,
        },
    },
